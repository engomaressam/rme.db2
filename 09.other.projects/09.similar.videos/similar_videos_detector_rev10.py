    ...
    def calculate_video_fingerprint(self, video_info):
        ...
        try:
            ...
            if video_info.duration > 60:  # For videos longer than 1 minute
                base_positions = [0.05, 0.15, 0.25, 0.35, 0.45, 0.55, 0.65, 0.75, 0.85, 0.95]
            elif video_info.duration > 20:  # For videos longer than 20 seconds
...
def main():
    ...
    detector.skip_errors = args.skip_errors
